\hypertarget{hip__complex_8h_source}{}\doxysection{hip\+\_\+complex.\+h}
\label{hip__complex_8h_source}\index{/Users/pvelesko/local/CHIP-\/SPV/HIP/include/hip/hip\_complex.h@{/Users/pvelesko/local/CHIP-\/SPV/HIP/include/hip/hip\_complex.h}}
...
\DoxyCodeLine{22 }
\DoxyCodeLine{23 \textcolor{preprocessor}{\#ifndef HIP\_INCLUDE\_HIP\_HIP\_COMPLEX\_H}}
\DoxyCodeLine{24 \textcolor{preprocessor}{\#define HIP\_INCLUDE\_HIP\_HIP\_COMPLEX\_H}}
\DoxyCodeLine{25 }
\DoxyCodeLine{26 \textcolor{preprocessor}{\#include <hip/hip\_common.h>}}
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{preprocessor}{\#if (defined(\_\_HIP\_PLATFORM\_HCC\_\_) || defined(\_\_HIP\_PLATFORM\_AMD\_\_)) \&\& !(defined(\_\_HIP\_PLATFORM\_NVCC\_\_) || defined(\_\_HIP\_PLATFORM\_NVIDIA\_\_))}}
\DoxyCodeLine{29 \textcolor{preprocessor}{\#include <hip/amd\_detail/amd\_hip\_complex.h>}}
\DoxyCodeLine{30 \textcolor{preprocessor}{\#elif !(defined(\_\_HIP\_PLATFORM\_HCC\_\_) || defined(\_\_HIP\_PLATFORM\_AMD\_\_)) \&\& (defined(\_\_HIP\_PLATFORM\_NVCC\_\_) || defined(\_\_HIP\_PLATFORM\_NVIDIA\_\_))}}
\DoxyCodeLine{31 \textcolor{preprocessor}{\#include <hip/nvidia\_detail/nvidia\_hip\_complex.h>}}
\DoxyCodeLine{32 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{33 \textcolor{preprocessor}{\#error("{}Must define exactly one of \_\_HIP\_PLATFORM\_AMD\_\_ or \_\_HIP\_PLATFORM\_NVIDIA\_\_"{}});}
