\hypertarget{vector__test__common_8h_source}{}\doxysection{vector\+\_\+test\+\_\+common.\+h}
\label{vector__test__common_8h_source}\index{/Users/pvelesko/local/CHIP-\/SPV/HIP/tests/src/deviceLib/vector\_test\_common.h@{/Users/pvelesko/local/CHIP-\/SPV/HIP/tests/src/deviceLib/vector\_test\_common.h}}
...
\DoxyCodeLine{25 }
\DoxyCodeLine{26 \textcolor{keyword}{template}<\textcolor{keywordtype}{bool} b, \textcolor{keyword}{typename} T = \textcolor{keywordtype}{void}>}
\DoxyCodeLine{27 \textcolor{keyword}{using} Enable\_if\_t = \textcolor{keyword}{typename} std::enable\_if<b, T>::type;}
