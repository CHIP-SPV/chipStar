...
# OpenCL dGPU
# if alltest_opencl_dgpu_failed.log exists, then skip
if [ ! -f alltest_opencl_dgpu_failed.log ]; then
...
# OpenCL iGPU
if [ ! -f alltest_opencl_igpu_failed.log ]; then
...
# Level Zero dGPU ICL
if [ ! -f alltest_level0icl_dgpu_failed.log ]; then
...
# Level Zero iGPU ICL
if [ ! -f alltest_level0icl_igpu_failed.log ]; then
...
# Level Zero dGPU RCL
if [ ! -f alltest_level0rcl_dgpu_failed.log ]; then
...
# Level Zero iGPU RCL
if [ ! -f alltest_level0rcl_igpu_failed.log ]; then
...
# OpenCL CPU
if [ ! -f alltest_opencl_cpu_failed.log ]; then
...
# OpenCL PoCL
if [ ! -f alltest_pocl_failed.log ]; then
