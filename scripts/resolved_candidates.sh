...
./scripts/check_for_resolved_tests.py ./build dgpu level0-reg 24 1 candidates
./scripts/check_for_resolved_tests.py ./build dgpu level0-imm 24 1 candidates
module unload level-zero/dpgu

module load level-zero/igpu
./scripts/check_for_resolved_tests.py ./build igpu level0-reg 24 1 candidates
module unload level-zero/igpu

module load opencl/dgpu
./scripts/check_for_resolved_tests.py ./build dgpu opencl 24 1 candidates
module unload opencl/dgpu

module load opencl/igpu
./scripts/check_for_resolved_tests.py ./build igpu opencl 24 1 candidates
...
./scripts/check_for_resolved_tests.py ./build cpu opencl 24 1 candidates
