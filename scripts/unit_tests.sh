...
make all build_tests install -j #&> /dev/null
...
for test_result in libCEED/igpu_opencl_make_check_result.txt \
                   libCEED/dgpu_opencl_make_check_result.txt \
                   libCEED/igpu_level0_make_check_result.txt \
