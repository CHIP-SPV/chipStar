...
# module list
../scripts/check.py ./ igpu level0-imm --num-threads=${num_threads} --timeout=$timeout --num-tries=$num_tries --categories --modules=on | tee igpu_level0_imm_make_check_result.txt
