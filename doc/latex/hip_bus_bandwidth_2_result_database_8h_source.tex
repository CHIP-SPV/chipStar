\hypertarget{hip_bus_bandwidth_2_result_database_8h_source}{}\doxysection{Result\+Database.\+h}
\label{hip_bus_bandwidth_2_result_database_8h_source}\index{/Users/pvelesko/local/CHIP-\/SPV/HIP/samples/1\_Utils/hipBusBandwidth/ResultDatabase.h@{/Users/pvelesko/local/CHIP-\/SPV/HIP/samples/1\_Utils/hipBusBandwidth/ResultDatabase.h}}
...
\DoxyCodeLine{48     \textcolor{keyword}{struct }\mbox{\hyperlink{struct_result_database_1_1_result}{Result}} \{}
...
\DoxyCodeLine{59 }
\DoxyCodeLine{60         \textcolor{keywordtype}{bool} operator<(\textcolor{keyword}{const} \mbox{\hyperlink{struct_result_database_1_1_result}{Result}}\& rhs) \textcolor{keyword}{const};}
\DoxyCodeLine{61 }
