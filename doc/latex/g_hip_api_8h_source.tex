\hypertarget{g_hip_api_8h_source}{}\doxysection{g\+Hip\+Api.\+h}
\label{g_hip_api_8h_source}\index{/Users/pvelesko/local/CHIP-\/SPV/HIP/tests/src/experimental/xcompile/gHipApi.h@{/Users/pvelesko/local/CHIP-\/SPV/HIP/tests/src/experimental/xcompile/gHipApi.h}}
...
\DoxyCodeLine{22 }
\DoxyCodeLine{23 }
\DoxyCodeLine{24 \textcolor{preprocessor}{\#ifndef GHIPAPI\_H}}
\DoxyCodeLine{25 \textcolor{preprocessor}{\#define GHIPAPI\_H}}
\DoxyCodeLine{26 }
\DoxyCodeLine{27 \textcolor{preprocessor}{\#include <stdlib.h>}}
\DoxyCodeLine{28 }
\DoxyCodeLine{29 \textcolor{keyword}{typedef} \textcolor{keyword}{struct }\{}
\DoxyCodeLine{30     \textcolor{keywordtype}{void}* hst\_ptr;}
\DoxyCodeLine{31     \textcolor{keywordtype}{void}* dev\_ptr;}
\DoxyCodeLine{32     \textcolor{keywordtype}{size\_t} size;}
\DoxyCodeLine{33     void (*h2d)();}
\DoxyCodeLine{34     void (*d2h)();}
\DoxyCodeLine{35     void (*malloc\_hip)();}
\DoxyCodeLine{36     void (*malloc\_hst)();}
\DoxyCodeLine{37 \} \mbox{\hyperlink{structmem__manager}{mem\_manager}};}
\DoxyCodeLine{38 }
\DoxyCodeLine{39 \mbox{\hyperlink{structmem__manager}{mem\_manager}}* mem\_manager\_start(\textcolor{keywordtype}{size\_t});}
\DoxyCodeLine{40 }
\DoxyCodeLine{41 \textcolor{keywordtype}{void} memset\_hst(\mbox{\hyperlink{structmem__manager}{mem\_manager}}*, \textcolor{keywordtype}{float});}
\DoxyCodeLine{42 }
