...
list(APPEND POCL_LEVEL0_FAILED_TESTS " ") 
...
list(APPEND POCL_LEVEL0_FAILED_TESTS "abort") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "fp16_math") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "fp16_half2_math") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "hip_async_binomial") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "BinomialOption") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "DCT") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "dwtHaar1D") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Histogram") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "RecursiveGaussian") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-simpleCallback") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-convolutionSeparable") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-histogram") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-binomialoptions") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-mergesort") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-scalarprod") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-scan") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-sortnet") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-FDTD3d") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "cuda-sobolqrng") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___fmaf_ieee_rd_float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___fmaf_ieee_rn_float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___fmaf_ieee_ru_float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___fmaf_ieee_rz_float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___funnelshift_l_int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___funnelshift_lc_int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___funnelshift_r_int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_deviceFunctions_CompileTest___funnelshift_rc_int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddEmptyNode_NegTest") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddDependencies_NegTest") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddEventRecordNode_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddEventWaitNode_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraph_BasicFunctional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNode_BasicFunctional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphClone_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphInstantiateWithFlags_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphInstantiateWithFlags_DependencyGraph") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddHostNode_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddHostNode_ClonedGraphwithHostNode") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNodeFromSymbol_GlobalMemory") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNodeFromSymbol_GlobalConstMemory") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNodeFromSymbol_GlobalMemoryWithKernel") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphChildGraphNodeGetGraph_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphNodeFindInClone_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecHostNodeSetParams_ClonedGraphwithHostNode") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecHostNodeSetParams_BasicFunc") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNodeToSymbol_GlobalMemory") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNodeToSymbol_GlobalConstMemory") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNodeToSymbol_MemcpyToSymbolNodeWithKernel") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemsetNodeSetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemsetNodeSetParams_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeSetParamsToSymbol_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeSetParamsToSymbol_Functional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphDestroyNode_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetNodes_Functional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetNodes_CapturedStream") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetNodes_ParamValidation") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetRootNodes_Functional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetRootNodes_CapturedStream") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetRootNodes_ParamValidation") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphHostNodeSetParams_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemcpyNode1D_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddChildGraphNode_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddChildGraphNode_OrgGraphAsChildGraph") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddChildGraphNode_CloneChildGraph") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddChildGraphNode_MultipleChildNodes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddChildGraphNode_SingleChildNode") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphNodeGetType_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParams1D_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParams1D_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetEdges_Functionality") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphGetEdges_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRemoveDependencies_Func_StrmCapture") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRemoveDependencies_ChangeComputeFunc") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRemoveDependencies_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphInstantiate_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecUpdate_Negative_Basic") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecUpdate_Negative_TypeChange") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecUpdate_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecEventRecordNodeSetEvent_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecEventRecordNodeSetEvent_VerifyEventNotChanged") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecEventRecordNodeSetEvent_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphEventWaitNodeSetEvent_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemsetNodeGetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemsetNodeSetParams_InvalidParams") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParamsFromSymbol_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParamsFromSymbol_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphEventRecordNodeGetEvent_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphEventRecordNodeSetEvent_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphEventWaitNodeGetEvent_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParams_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_hipStreamPerThread") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_InterStrmEventSync_defaultflag") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_InterStrmEventSync_blockingflag") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_InterStrmEventSync_diffflags") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_InterStrmEventSync_diffprio") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_multiplestrms") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_ColligatedStrmCapture_func") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_Multithreaded_Global") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_Multithreaded_ThreadLocal") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_Multithreaded_Relaxed") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_CapturingFromWithinStrms") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_DetectingInvalidCapture") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_CapturingMultGraphsFrom1Strm") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_EndingCapturewhenCaptureInProgress") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_nestedStreamCapture") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_streamReuse") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_captureComplexGraph") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamBeginCapture_captureEmptyStreams") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamIsCapturing_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamIsCapturing_Functional_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamIsCapturing_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamIsCapturing_hipStreamPerThread") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_BasicFunctional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_hipStreamPerThread") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_UniqueID") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_ArgValidation") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamEndCapture_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamEndCapture_Thread_Negative") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeSetParamsFromSymbol_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeSetParamsFromSymbol_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecEventWaitNodeSetEvent_SetAndVerifyMemory") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecEventWaitNodeSetEvent_VerifyEventNotChanged") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecEventWaitNodeSetEvent_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddMemsetNode_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphAddKernelNode_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeGetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeGetParams_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeSetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeSetParams_Functional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphKernelNodeGetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphKernelNodeSetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphKernelNodeSetParams_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphKernelNodeGetSetParams_Functional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecKernelNodeSetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecKernelNodeSetParams_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphLaunch_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphMemcpyNodeSetParams1D_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParamsToSymbol_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecMemcpyNodeSetParamsToSymbol_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphNodeGetDependentNodes_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphNodeGetDependentNodes_ParamValidation") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphNodeGetDependencies_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphNodeGetDependencies_ParamValidation") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphHostNodeGetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecChildGraphNodeSetParams_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecChildGraphNodeSetParams_BasicFunc") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphExecChildGraphNodeSetParams_ChildTopology") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_v2_BasicFunctional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_v2_hipStreamPerThread") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_v2_UniqueID") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetCaptureInfo_v2_ParamValidation") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObjectCreate_Functional_1") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObjectCreate_Functional_2") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObjectCreate_Functional_3") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObjectCreate_Functional_4") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObjectCreate_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObjectRelease_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObjectRetain_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipUserObj_Negative_Test") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRetainUserObject_Functional_1") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRetainUserObject_Functional_2") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRetainUserObject_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphReleaseUserObject_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRetainUserObject_Negative_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGraphRetainUserObject_Negative_Null_Object") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_ReferenceFromKernelandhipMemset - int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_ReferenceFromKernelandhipMemset - float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_ReferenceFromKernelandhipMemset - double") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_Flags - int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_Flags - float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_Flags - double") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_Negative - int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_Negative - float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostRegister_Negative - double") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostUnregister_MemoryNotAccessableAfterUnregister") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostUnregister_NullPtr") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostUnregister_NotRegisteredPointer") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostUnregister_AlreadyUnregisteredPointer") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3D_ValidatePitch") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemAllocPitch_ValidatePitch") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3D_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocPitch_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemAllocPitch_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocPitch_KernelLaunch - int") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocPitch_KernelLaunch - float") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocPitch_KernelLaunch - double") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostGetFlags_flagCombos") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostGetFlags_DifferentThreads") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostGetFlags_InvalidArgs") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostGetDevicePointer_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocManaged_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset_Negative_InvalidPtr") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset_Negative_OutOfBoundsSize") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset_Negative_OutOfBoundsPtr") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2D_Negative_InvalidPtr") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2D_Negative_InvalidSizes") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2D_Negative_OutOfBoundsPtr") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset3D_Negative_InvalidPtr") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset3D_Negative_ModifiedPtr") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset3D_Negative_InvalidSizes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset3D_Negative_OutOfBounds") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2D_BasicFunctional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2DAsync_BasicFunctional") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemPrefetchAsync_NonPageSz") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemcpyFromToSymbol_Negative") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipPtrGetAttribute_Simple") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemPoolApi_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemPoolApi_BasicAlloc") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemPoolApi_BasicTrim") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemPoolApi_BasicReuse") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemPoolApi_Opportunistic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemPoolApi_Default") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2DAsync_WithKernel") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2DAsync_MultiThread") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc_ArgumentValidation") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipHostGetDevicePointer_NullCheck") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemsetFunctional_ZeroSize_hipMemset") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemsetFunctional_ZeroSize_hipMemsetD32") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemsetFunctional_ZeroSize_hipMemsetD16") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemsetFunctional_ZeroSize_hipMemsetD8") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemsetFunctional_PartialSet_1D") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemsetFunctional_ZeroValue_2D") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemsetFunctional_PartialSet_2D") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_DiffSizes") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MultiThread") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - uint") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - int4") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - ushort") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - short2") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - char") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - char4") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - float2") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_MaxTexture_Default - float4") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_DifferentChannelSizes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_NullArrayPtr") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_NullDescPtr") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_BadFlags") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_8bitFloat - float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_8bitFloat - float2") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_8bitFloat - float4") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_BadNumberOfBits") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_3ChannelElement") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_ChannelAfterZeroChannel") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_InvalidChannelFormat") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMallocArray_Negative_NumericLimit") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_DiffSizes") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_MultiThread") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_NullArrayPtr") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_NullDescPtr") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_ZeroHeight") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_InvalidFlags") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_BadChannelLayout") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_8BitFloat") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_DifferentChannelSizes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_BadChannelSize") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_NumericLimit") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_Non2DTextureGather - char") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_Non2DTextureGather - uchar2") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_Non2DTextureGather - short4") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_Non2DTextureGather - float2") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMalloc3DArray_Negative_Non2DTextureGather - float4") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3D_MultipleDataTypes - uint8_t") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3D_MultipleDataTypes - int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3D_MultipleDataTypes - float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3D_HosttoDevice") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3D_ExtentValidation") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3DAsync_MultipleDataTypes - uint8_t") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3DAsync_MultipleDataTypes - int") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3DAsync_MultipleDataTypes - float") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3DAsync_HosttoDevice") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvMemcpy3DAsync_ExtentValidation") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipPointerGetAttribute_MemoryTypes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipPointerGetAttribute_KernelUpdation") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipPointerGetAttribute_BufferID") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipPointerGetAttribute_MappedMem") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipPointerGetAttribute_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvPtrGetAttributes_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDrvPtrGetAttributes_Functional") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemGetInfo_DifferentMallocSmall") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemGetInfo_ParaSmall") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemGetInfo_ParaNonDiv") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemGetInfo_ParaMultiSmall") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemGetInfo_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeNegativeDev") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeNegativeHost") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeNegativeArray") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeDoubleDevice") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeDoubleHost") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeDoubleArray") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTDev - char") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTDev - int") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTDev - float2") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTDev - float4") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTHost - char") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTHost - int") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTHost - float2") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTHost - float4") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTArray - char") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTArray - int") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTArray - float2") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipFreeMultiTArray - float4") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset2DASyncMulti") # Timeout
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMemset3DASyncMulti") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamGetFlags_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamDestroy_Negative_DoubleDestroy") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamDestroy_Negative_NullStream") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamSynchronize_UninitializedStream") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipStreamAddCallback_StrmSyncTiming") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipEvent") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipEventRecord") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipEventIpc") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipEventSynchronize_Default_Positive") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipEventSynchronize_NoEventRecord_Positive") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetName_NegTst") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetPCIBusId_Negative_PartialFill") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetCacheConfig_Positive_Default") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetCacheConfig_Positive_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetCacheConfig_Positive_Threaded") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_HipDeviceGetCacheConfig_Negative_Parameters") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceTotalMem_NegTst") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetSetDeviceFlags_NullptrFlag") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetSetDeviceFlags_InvalidFlag") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetSetDeviceFlags_ValidFlag") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetSetDeviceFlags_SetThenGet") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetSetDeviceFlags_Threaded") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetDeviceFlags_Positive_Context") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetSetDevice_MultiThreaded") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipSetGetDevice_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetUuid_Positive") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetUuid_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetDefaultMemPool_Positive_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetDefaultMemPool_Negative_Parameters") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceSetLimit_SetGet") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetSharedMemConfig_Positive_Default") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetSharedMemConfig_Positive_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetSharedMemConfig_Positive_Threaded") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetSharedMemConfig_Negative_Parameters") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceReset_Positive_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceReset_Positive_Threaded") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceSetMemPool_Positive_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceSetMemPool_Negative_Parameters") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetMemPool_Positive_Default") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetMemPool_Positive_Basic") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetMemPool_Positive_Threaded") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDeviceGetMemPool_Negative_Parameters") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipInit_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipDriverGetVersion_Negative") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcOpenMemHandle_Negative_Open_In_Creating_Process") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcOpenMemHandle_Negative_Open_In_Two_Contexts_Same_Device") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcGetMemHandle_Positive_Unique_Handles_Separate_Allocations") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcGetMemHandle_Positive_Unique_Handles_Reused_Memory") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcGetMemHandle_Negative_Handle_For_Freed_Memory") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcGetMemHandle_Negative_Out_Of_Bound_Pointer") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcCloseMemHandle_Positive_Reference_Counting") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipIpcCloseMemHandle_Negative_Close_In_Originating_Process") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_printf_flags") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_printf_specifier") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipCreateTextureObject_ArgValidation") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipCreateTextureObject_LinearResource") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipCreateTextureObject_Pitch2DResource") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetChannelDesc_CreateAndGet") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTexObjPitch_texture2D - float") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTexObjPitch_texture2D - int") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTexObjPitch_texture2D - unsigned char") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTexObjPitch_texture2D - int16_t") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTexObjPitch_texture2D - char") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTexObjPitch_texture2D - unsigned int") # SEGFAULT
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_tex1Dfetch_CheckModes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTextureObj1DCheckRGBAModes - array") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTextureObj1DCheckSRGBAModes - array") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTextureObj1DCheckRGBAModes - buffer") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTextureObj1DCheckSRGBAModes - buffer") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTextureObj2DCheckRGBAModes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipTextureObj2DCheckSRGBAModes") # Failed
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipLaunchBounds_With_maxThreadsPerBlock_Check") # NUMERICAL
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipLaunchBounds_With_maxThreadsPerBlock_blocksPerCU_Check") # NUMERICAL
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipMultiThreadStreams2") # Subprocess aborted
list(APPEND POCL_LEVEL0_FAILED_TESTS "Unit_hipGetLastError_Positive_Basic") # Failed
...
list(APPEND ALL_FAILED_TESTS ${POCL_LEVEL0_FAILED_TESTS})
...
string(REGEX REPLACE ";" "\$|" POCL_OPENCL_FAILED_TESTS_STR "${POCL_LEVEL0_FAILED_TESTS}")
...
string(CONCAT POCL_OPENCL_FAILED_TESTS_STR ${POCL_OPENCL_FAILED_TESTS_STR} "\$|")
...
FILE(WRITE "${CMAKE_BINARY_DIR}/test_lists/pocl_opencl_failed_tests.txt" "\"${POCL_OPENCL_FAILED_TESTS_STR}\"")
