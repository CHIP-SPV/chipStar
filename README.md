...
CHIP_MODULE_CACHE_DIR=/path/to/desired/dir      # Module/Program cache dir. Defaults to /tmp, if caching is undesired, set to empty string i.e. export CHIP_MODULE_CACHE_DIR=
```
